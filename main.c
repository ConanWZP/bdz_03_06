...
#define IS_MESSURING_C HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_7)
...
#define IS_NUMBER_AFTER_COMMA_C HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_8)

#define IS_NEW_UNIT_C HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_9)
